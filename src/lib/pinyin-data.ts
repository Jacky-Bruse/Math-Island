...
export const WHOLE_SYLLABLES: WholeSyllable[] = [
  ...
  { id: 'ri', syllable: 'ri', audioKey: 'ri1' },
  { id: 'zi', syllable: 'zi', audioKey: 'zi1' },
  { id: 'ci', syllable: 'ci', audioKey: 'ci1' },
  { id: 'si', syllable: 'si', audioKey: 'si1' },
  { id: 'yi', syllable: 'yi', audioKey: 'yi1' },
  { id: 'wu', syllable: 'wu', audioKey: 'wu1' },
  { id: 'yu', syllable: 'yu', audioKey: 'yu1' },
  { id: 'ye', syllable: 'ye', audioKey: 'ye1' },
  { id: 'yue', syllable: 'yue', audioKey: 'yue1' },
  { id: 'yuan', syllable: 'yuan', audioKey: 'yuan1' },
  { id: 'yin', syllable: 'yin', audioKey: 'yin1' },
  { id: 'yun', syllable: 'yun', audioKey: 'yun1' },
