...
export const INITIALS: Initial[] = [
  ...
  { id: 'd', letter: 'd', audioSyllable: 'de2', canBlend: true },
  { id: 't', letter: 't', audioSyllable: 'te4', canBlend: true },
  { id: 'n', letter: 'n', audioSyllable: 'ne4', canBlend: true },
  { id: 'l', letter: 'l', audioSyllable: 'le4', canBlend: true },
  ...
  { id: 'r', letter: 'r', audioSyllable: 'ri4', canBlend: true },
  { id: 'z', letter: 'z', audioSyllable: 'zi1', canBlend: true },
  { id: 'c', letter: 'c', audioSyllable: 'ci2', canBlend: true },
